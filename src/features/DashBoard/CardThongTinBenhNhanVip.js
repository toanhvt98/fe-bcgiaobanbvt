import {
  ...
  function CardThongTinBenhNhanVip({ databenhnhan,title,value,colorCardWarning,titleMore }) {
        ...
        <ThemeProvider theme={darkTheme}>
          <div>
            <Modal open={open} onClose={handleClose}>
              ...
              >
                <Typography variant={isSmallScreen?"h6":"h5"} gutterBottom align="center" color={darkMode?"#FFF":"#1939B7"}>
                 {titleMore}
                </Typography>
                {/* <Grid
                  container
...
<Table>
          <TableHead>
            <TableRow sx={rowStyle}>
              ...
              <TableCell style={commonStyleReponsive}>Ngày sinh</TableCell>
              ...
              <TableCell style={commonStyleReponsive}>Ngày vào viện</TableCell>
          ...
          <TableBody>
            {databenhnhan && databenhnhan.map((row, index) => (
              <TableRow key={index} sx={rowStyle}>
                ...
                <TableCell style={commonStyleLeftReponsive}>
                  {row.hc_xaname} - {row.hc_huyenname} - {row.tinhname}
                </TableCell>
